      ...
      return (
        <View>
          <Image
            ...
            source={require('./assets/1_2_1.jpg')}
          />
          <Text style={styles.recipeWord}>將西瓜切小塊</Text>
        </View>
      );
    } else if (page === 2) {
      return (
        <View>
          <Image
            ...
            source={require('./assets/1_2_2.jpg')}
          />
      ...
      return (
        <View>
          <Image
            ...
            source={require('./assets/1_2_3.jpg')}
          />
          <Text style={styles.recipeWord}>
            根據個人口感調整攪拌時間，建議1檔位30秒
          </Text>
        </View>
      );
    } else {
      return (
        <View>
          <Image
            ...
            source={require('./assets/1_2_4.jpg')}
          />
          <Text style={styles.recipeWord}>
          可以加入些許冰塊，即可享用清涼爽口的西瓜牛奶
          </Text>
        </View>
      );
    }
